...
//   const safariPackage = safariPackages.find(pkg => pkg.id === params.packageId);
...
//             <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-96 mb-6" />
            
//             <div className="bg-white p-6 rounded-xl shadow border border-gray-200">
//               <h1 className="text-3xl font-bold text-gray-900 mb-2">{safariPackage.title}</h1>
//               <p className="text-gray-600 mb-6">{safariPackage.description}</p>
...
//                 <div>
//                   <h3 className="font-semibold text-lg mb-3">Inclusions</h3>
//                   <ul className="space-y-2">
//                     <li className="flex items-start">
//                       <span className="text-green-500 mr-2">✓</span>
//                       <span>All safari permits and fees</span>
//                     </li>
//                     <li className="flex items-start">
//                       <span className="text-green-500 mr-2">✓</span>
//                       <span>Accommodation in eco-friendly lodges</span>
//                     </li>
//                     <li className="flex items-start">
//                       <span className="text-green-500 mr-2">✓</span>
...
//                       <li>Evening safari in Zone 1 (3:30 PM - 6:30 PM)</li>
...
//                       <li>Evening safari in Zone 3</li>
//                     </ul>
//                   </div>
//                 </div>
//               </div>
...
//                 <p className="text-amber-700">Book 30 days in advance and save 10% on your total package!</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//       animals: 'Tigers, leopards, barasingha',
//       area: '940 sq km'
//     },
//     resorts: [
//       {
...
//         price: '$399',
//         includes: ['3 nights stay', '4 safaris', 'All meals']
//       }
//     ]
//   },
//   {
...
//       animals: 'Tigers, leopards, wild boar',
//       area: '716 sq km'
//     },
//     resorts: [
//       {
...
//         price: '$599',
//         includes: ['Luxury treehouse', 'Private safaris', 'All meals']
//       }
//     ]
//   }
// ];
...
// export default function PackagePage({ params }: { params: { packageId: string } }) {
//   const safariPackage = allPackages.find(pkg => pkg.id === params.packageId);
