...
//   return (
//     <div className={`relative h-screen overflow-hidden ${roboto.variable}`}>
//       {/* Background Video */}
...
//         >
//           {/* <source src="/videos/jungle-hero.mp4" type="video/mp4" /> */}
//         </video>
//         <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
//       </div>

//       {/* Content */}
//       <div className="relative z-10 flex flex-col justify-center h-full px-6 lg:px-16 text-white">
//         <motion.div
...
//           className="max-w-3xl"
//         >
//           <span className="inline-block px-3 py-1 mb-4 text-sm font-semibold bg-green-600 rounded-full">
//             🐘 Eco-Friendly Tours
//           </span>
//           <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight font-extralight">
//             Experience the Wild Heart of India
//           </h1>
//           <p className="text-lg md:text-xl mb-8 max-w-2xl font-roboto">
//             Discover majestic tigers, explore ancient jungles, and create 
//             unforgettable memories with our expert-guided safaris.
//           </p>
//           <div className="flex flex-col sm:flex-row gap-4">
//             <Link
//               href="/packages"
//               className="px-8 py-4 bg-green-600 hover:bg-green-700 text-white font-bold font-roboto rounded-lg transition-colors text-center"
//             >
//               Explore Safari Packages
//             </Link>
//             <Link
//               href="/booking"
//               className="px-8 py-4 bg-white/10 hover:bg-white/20 border border-white text-white font-bold font-roboto rounded-lg transition-colors text-center"
//             >
//               Book Instant Safari
//             </Link>
//           </div>
...
// import { Mountain, PawPrint, Binoculars, Map, Leaf, Phone } from 'lucide-react';
// import Link from 'next/link';

// export default function HomeSection() {
//   return (
//     <div className="bg-warm_cream">
//       {/* Hero Section */}
//       <section className="relative bg-gradient-to-br from-sand_beige to-warm_cream overflow-hidden">
...
//               className="text-4xl md:text-5xl lg:text-6xl font-bold font-secondary text-charcoal mb-6 leading-tight"
//             >
//               Embark on <span className="text-jungle_green">Wild</span> Adventures
//             </motion.h1>
//             <motion.p 
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ duration: 0.6, delay: 0.1 }}
//               className="text-lg md:text-xl text-charcoal mb-8 max-w-lg"
//             >
...
//             >
//               <Link href="/packages" className="bg-sunset_orange hover:bg-tiger_orange text-cloud_white font-medium py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-md">
//                 Explore Packages
//               </Link>
//               <Link href="#features" className="border-2 border-jungle_green text-jungle_green font-medium py-3 px-8 rounded-full transition-all duration-300 hover:bg-jungle_green hover:text-cloud_white">
//                 Learn More
//               </Link>
//             </motion.div>
//           </div>
...
//               />
//             </motion.div>
//             <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-leaf_green opacity-20 rounded-full"></div>
//             <div className="absolute -top-6 -right-6 w-24 h-24 bg-parrot_blue opacity-20 rounded-full"></div>
//           </div>
//         </div>
//       </section>

//       {/* Features Section */}
//       <section id="features" className="py-16 md:py-24 bg-cloud_white">
//         <div className="container mx-auto px-4">
//           <div className="text-center mb-16">
//             <h2 className="text-3xl md:text-4xl font-bold font-secondary text-jungle_green mb-4">Why Choose Our Safaris</h2>
...
//                 viewport={{ once: true }}
//                 className="bg-cloud_white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300"
//               >
//                 <div className="w-16 h-16 bg-sage_green bg-opacity-20 rounded-full flex items-center justify-center mb-6">
//                   {feature.icon}
//                 </div>
//                 <h3 className="text-xl font-semibold text-charcoal mb-3">{feature.title}</h3>
//                 <p className="text-stone_gray">{feature.description}</p>
//               </motion.div>
//             ))}
//           </div>
//         </div>
...
//       <section className="py-16 md:py-24 bg-gradient-to-b from-cloud_white to-sand_beige">
//         <div className="container mx-auto px-4">
//           <div className="text-center mb-16">
//             <h2 className="text-3xl md:text-4xl font-bold font-secondary text-jungle_green mb-4">Featured Safari Packages</h2>
//             <p className="text-lg text-charcoal max-w-2xl mx-auto">
...
//                 transition={{ duration: 0.5, delay: index * 0.1 }}
//                 viewport={{ once: true }}
//                 className="bg-cloud_white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300"
//               >
...
//                     <p className="text-sage_green">{pkg.highlight}</p>
//                   </div>
//                 </div>
//                 <div className="p-6">
//                   <div className="flex justify-between items-center mb-4">
//                     <span className="text-stone_gray">{pkg.duration}</span>
//                     <span className="text-xl font-bold text-green-300">{pkg.price}</span>
//                   </div>
//                   <Link 
//                     href={`/packages/${pkg.id}`}
//                     className="block w-full text-center bg-sunset_orange hover:bg-tiger_orange text-cloud_white font-medium py-2 px-4 rounded-full transition-colors duration-300"
//                   >
//                     View Details
//                   </Link>
//                 </div>
...
//             <Link 
//               href="/packages"
//               className="inline-block border-2 border-jungle_green text-jungle_green hover:bg-jungle_green hover:text-cloud_white font-medium py-3 px-8 rounded-full transition-colors duration-300"
//             >
//               View All Packages
//             </Link>
//           </div>
...
//       {/* Testimonial Section */}
//       <section className="py-16 md:py-24 bg-forest_green text-cloud_white">
//         <div className="container mx-auto px-4">
//           <div className="text-center mb-16">
//             <h2 className="text-3xl md:text-4xl font-bold font-secondary mb-4">What Our Guests Say</h2>
//             <p className="text-sage_green max-w-2xl mx-auto">
...
//                 transition={{ duration: 0.5, delay: index * 0.1 }}
//                 viewport={{ once: true }}
//                 className="bg-jungle_green bg-opacity-50 p-8 rounded-2xl"
//               >
//                 <div className="flex mb-4">
//                   {[...Array(5)].map((_, i) => (
//                     <svg
//                       key={i}
//                       className={`w-5 h-5 ${i < testimonial.rating ? 'text-golden_yellow' : 'text-stone_gray'}`}
//                       fill="currentColor"
//                       viewBox="0 0 20 20"
//                     >
...
//                   <p className="text-sage_green text-sm">{testimonial.tour}</p>
//                 </div>
//               </motion.div>
//             ))}
//           </div>
...
//       {/* CTA Section */}
//       <section className="py-16 md:py-24 bg-charcoal text-cloud_white">
...
//             transition={{ duration: 0.6 }}
//             viewport={{ once: true }}
//             className="text-3xl md:text-4xl font-bold font-secondary mb-6"
//           >
...
//             <Link 
//               href="/contact"
//               className="bg-sunset_orange hover:bg-tiger_orange text-cloud_white font-medium py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-md"
//             >
//               Get in Touch
//             </Link>
//             <Link 
//               href="tel:+919876543210"
//               className="border-2 border-cloud_white text-cloud_white hover:bg-cloud_white hover:text-charcoal font-medium py-3 px-8 rounded-full transition-colors duration-300 flex items-center gap-2"
//             >
